...
import { saveMenuItem } from '../../../../backend/services/menuService'
...
const s = StyleSheet.create({
  ...
  photoContainer: { height: 160, borderRadius: 14, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', alignItems: 'center', justifyContent: 'center', marginBottom: 12, overflow: 'hidden' },
  ...
  photoBtn: { flex: 1, backgroundColor: '#F3F4F6', borderRadius: 10, paddingVertical: 10, alignItems: 'center', ...shadow(2, 2) },
  ...
  typeBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F9FAFB', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)' },
