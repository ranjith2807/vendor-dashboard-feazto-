...
const s = StyleSheet.create({
  ...
  photoBtn: { flex: 1, backgroundColor: C.cream, borderRadius: 10, paddingVertical: 10, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000', alignItems: 'center', ...shadow(2, 2) },
  ...
  stepBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: C.yellow, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000', alignItems: 'center', justifyContent: 'center', ...shadow(2, 2) },
  ...
  chip: { backgroundColor: C.cream, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000' },
  ...
  typeBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.cream, borderRadius: 12, padding: 12, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000' },
  ...
  saveBtn: { backgroundColor: C.yellow, borderRadius: 14, padding: 16, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', alignItems: 'center', ...shadow(4, 4) },
  ...
  outlineBtn: { flex: 1, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000', borderRadius: 12, padding: 13, alignItems: 'center' },
  outlineBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  primaryBtn: { flex: 1, backgroundColor: C.yellow, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', padding: 13, alignItems: 'center', ...shadow(3, 3) },
