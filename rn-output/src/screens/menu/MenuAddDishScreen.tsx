...
const s = StyleSheet.create({
  ...
  photoContainer: { height: 160, borderRadius: 14, backgroundColor: C.cream, alignItems: 'center', justifyContent: 'center', marginBottom: 12, overflow: 'hidden', ...border3D },
  ...
  photoBtn: { flex: 1, backgroundColor: C.cream, borderRadius: 10, paddingVertical: 10, alignItems: 'center', ...shadow(2, 2), ...border3D },
  photoBtnDanger: { backgroundColor: '#FEE2E2', ...border3D },
  ...
  stepBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: C.yellow, alignItems: 'center', justifyContent: 'center', ...shadow(2, 2), ...border3D },
  ...
  chip: { backgroundColor: C.cream, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, ...border3D },
  ...
  typeBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.cream, borderRadius: 12, padding: 12, ...border3D },
  ...
  saveBtn: { backgroundColor: C.yellow, borderRadius: 14, padding: 16, alignItems: 'center', ...shadow(4, 4), ...border3D },
  ...
  outlineBtn: { flex: 1, borderRadius: 12, padding: 13, alignItems: 'center', ...border3D, backgroundColor: C.white },
  outlineBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  primaryBtn: { flex: 1, backgroundColor: C.yellow, borderRadius: 12, padding: 13, alignItems: 'center', ...shadow(3, 3), ...border3D },
