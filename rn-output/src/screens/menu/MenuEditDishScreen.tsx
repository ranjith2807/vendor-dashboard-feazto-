...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: C.white, borderRadius: 14, ...shadow(4, 4), ...border3D, padding: 16 },
  ...
  photoContainer: { height: 140, borderRadius: 12, backgroundColor: C.cream, alignItems: 'center', justifyContent: 'center', marginBottom: 10, overflow: 'hidden', ...border3D },
  photoPreview: { width: '100%', height: '100%' },
  changePhotoBtn: { backgroundColor: C.cream, borderRadius: 10, paddingVertical: 9, alignItems: 'center', ...border3D },
  ...
  stepBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: C.yellow, alignItems: 'center', justifyContent: 'center', ...shadow(2, 2), ...border3D },
  ...
  chip: { backgroundColor: C.cream, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, ...border3D },
  chipActive: { backgroundColor: C.black },
  chipText: { fontFamily: F.interBold, fontSize: 12, color: C.black },
  chipTextActive: { color: C.yellow },
  typeBtn: { flex: 1, backgroundColor: C.cream, borderRadius: 10, padding: 10, alignItems: 'center', ...border3D },
  ...
  primaryBtn: { backgroundColor: C.yellow, borderRadius: 14, padding: 16, alignItems: 'center', ...shadow(4, 4), ...border3D },
  primaryBtnText: { fontFamily: F.barlow, fontSize: 17, letterSpacing: 1, color: C.black },
  outlineBtn: { flex: 1, backgroundColor: C.white, borderRadius: 12, padding: 13, alignItems: 'center', ...border3D },
  outlineBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  dangerBtn: { flex: 1, backgroundColor: C.red, borderRadius: 12, padding: 13, alignItems: 'center', ...shadow(3, 3), ...border3D },
  ...
  emojiOption: { width: 56, height: 56, borderRadius: 14, backgroundColor: C.cream, alignItems: 'center', justifyContent: 'center', ...border3D },
