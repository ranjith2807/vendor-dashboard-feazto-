...
import {
  ...
  TextInput, StyleSheet, Modal, Image, TouchableOpacity,
} from 'react-native'
...
const s = StyleSheet.create({
  ...
  photoContainer: { height: 140, borderRadius: 12, backgroundColor: C.cream, alignItems: 'center', justifyContent: 'center', marginBottom: 10, overflow: 'hidden', borderBottomWidth: 3, borderRightWidth: 3, borderBottomColor: '#000', borderRightColor: '#000' },
  photoPreview: { width: '100%', height: '100%' },
  changePhotoBtn: { backgroundColor: C.cream, borderRadius: 10, paddingVertical: 9, alignItems: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  chip: { backgroundColor: C.cream, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  chipActive: { backgroundColor: C.black },
  chipText: { fontFamily: F.interBold, fontSize: 12, color: C.black },
  chipTextActive: { color: C.yellow },
  typeBtn: { flex: 1, backgroundColor: C.cream, borderRadius: 10, padding: 10, alignItems: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  availRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: C.cream, borderRadius: 10, padding: 12, borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  modalSheet: { backgroundColor: C.white, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 36, borderTopWidth: 2, borderTopColor: '#000' },
  ...
  emojiOption: { width: 56, height: 56, borderRadius: 14, backgroundColor: C.cream, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
