...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: C.white, borderRadius: 14, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(4, 4), padding: 16 },
  ...
  changePhotoBtn: { backgroundColor: C.cream, borderRadius: 10, paddingVertical: 9, alignItems: 'center', borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000' },
  ...
  stepBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: C.yellow, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000', alignItems: 'center', justifyContent: 'center', ...shadow(2, 2) },
  ...
  chip: { backgroundColor: C.cream, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000' },
  chipActive: { backgroundColor: C.black },
  chipText: { fontFamily: F.interBold, fontSize: 12, color: C.black },
  chipTextActive: { color: C.yellow },
  typeBtn: { flex: 1, backgroundColor: C.cream, borderRadius: 10, padding: 10, alignItems: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000' },
  ...
  primaryBtn: { backgroundColor: C.yellow, borderRadius: 14, padding: 16, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', alignItems: 'center', ...shadow(4, 4) },
  primaryBtnText: { fontFamily: F.barlow, fontSize: 17, letterSpacing: 1, color: C.black },
  outlineBtn: { flex: 1, backgroundColor: C.white, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000', borderRadius: 12, padding: 13, alignItems: 'center' },
  outlineBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  dangerBtn: { flex: 1, backgroundColor: C.red, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', padding: 13, alignItems: 'center', ...shadow(3, 3) },
  ...
  emojiOption: { width: 56, height: 56, borderRadius: 14, backgroundColor: C.cream, borderBottomWidth: 2, borderRightWidth: 2, borderColor: '#000', alignItems: 'center', justifyContent: 'center' },
