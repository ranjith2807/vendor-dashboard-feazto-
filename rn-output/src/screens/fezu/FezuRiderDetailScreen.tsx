...
const s = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: C.white, borderRadius: 12, ...shadow(3,3), padding: 12, alignItems: 'center' },
  ...
  recentCard: { backgroundColor: C.white, borderRadius: 14, ...shadow(4,4), padding: 14 },
