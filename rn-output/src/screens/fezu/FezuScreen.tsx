...
const s = StyleSheet.create({
  ...
  availBadge: { marginLeft: 'auto', backgroundColor: C.black, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 4, ...border3D },
  ...
  tab: { flex: 1, backgroundColor: C.white, borderRadius: 20, paddingVertical: 8, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center', ...border3D },
  ...
  statCard: { width: '47%', backgroundColor: C.white, borderRadius: 12, ...shadow(4,4), ...border3D, padding: 12 },
  ...
  emptyCard: { backgroundColor: C.white, borderRadius: 12, ...shadow(3,3), ...border3D, padding: 20, alignItems: 'center' },
  emptyText: { fontFamily: F.inter, fontSize: 13, color: C.black, opacity: 0.5 },
  readyCard: { backgroundColor: C.white, borderRadius: 12, ...shadow(4,4,'#FFC50A'), ...border3D, padding: 12 },
  ...
  assignBtn: { backgroundColor: C.yellow, borderRadius: 9, padding: 10, alignItems: 'center', ...shadow(3,3), ...border3D },
  assignBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  riderCard: { backgroundColor: C.white, borderRadius: 13, ...shadow(4,4), ...border3D, padding: 12 },
  riderCardAssigned: { ...shadow(5,5, C.yellow) },
  riderRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  riderAvatar: { width: 46, height: 46, borderRadius: 23, alignItems: 'center', justifyContent: 'center', ...border3D },
  ...
  callBtn: { flex: 1, backgroundColor: C.white, borderRadius: 9, padding: 8, alignItems: 'center', ...border3D },
  callBtnText: { fontFamily: F.barlow, fontSize: 13, color: C.black },
  riderAssignBtn: { flex: 2, backgroundColor: C.yellow, borderRadius: 9, padding: 8, alignItems: 'center', ...shadow(3,3), ...border3D },
  ...
  histCard: { backgroundColor: C.white, borderRadius: 12, ...shadow(3,3), ...border3D, padding: 12 },
