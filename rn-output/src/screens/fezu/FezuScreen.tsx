...
const s = StyleSheet.create({
  ...
  mascotCircle: { width: 52, height: 52, borderRadius: 26, backgroundColor: C.black, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 3, borderRightWidth: 3, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  availBadge: { marginLeft: 'auto', backgroundColor: C.black, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 4, borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  tab: { flex: 1, backgroundColor: C.white, borderRadius: 20, paddingVertical: 8, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  readyBadge: { backgroundColor: C.green, borderRadius: 6, paddingHorizontal: 9, paddingVertical: 2, borderBottomWidth: 1.5, borderRightWidth: 1.5, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  callBtn: { flex: 1, backgroundColor: C.white, borderRadius: 9, padding: 8, alignItems: 'center', borderBottomWidth: 2, borderRightWidth: 2, borderBottomColor: '#000', borderRightColor: '#000' },
  ...
  histBadge: { borderRadius: 5, paddingHorizontal: 8, paddingVertical: 1, borderBottomWidth: 1.5, borderRightWidth: 1.5, borderBottomColor: '#000', borderRightColor: '#000' },
