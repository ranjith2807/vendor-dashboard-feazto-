...
const s = StyleSheet.create({
  ...
  headerBg: { backgroundColor: C.yellow, paddingHorizontal: 20, paddingVertical: 14, borderBottomWidth: 3, borderRightWidth: 3, borderColor: '#000' },
  ...
  tab: { flex: 1, backgroundColor: C.white, borderRadius: 20, paddingVertical: 8, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000' },
  ...
  emptyCard: { backgroundColor: C.white, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(3,3), padding: 20, alignItems: 'center' },
  emptyText: { fontFamily: F.inter, fontSize: 13, color: C.black, opacity: 0.5 },
  readyCard: { backgroundColor: C.white, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(4,4,'#FFC50A'), padding: 12 },
  ...
  assignBtn: { backgroundColor: C.yellow, borderRadius: 9, padding: 10, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', alignItems: 'center', ...shadow(3,3) },
  assignBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  riderCard: { backgroundColor: C.white, borderRadius: 13, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(4,4), padding: 12 },
  ...
  callBtn: { flex: 1, backgroundColor: C.white, borderRadius: 9, padding: 8, alignItems: 'center', borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000' },
  callBtnText: { fontFamily: F.barlow, fontSize: 13, color: C.black },
  riderAssignBtn: { flex: 2, backgroundColor: C.yellow, borderRadius: 9, padding: 8, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', alignItems: 'center', ...shadow(3,3) },
  ...
  histCard: { backgroundColor: C.white, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(3,3), padding: 12 },
