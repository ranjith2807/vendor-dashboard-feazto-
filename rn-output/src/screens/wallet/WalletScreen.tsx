...
const s = StyleSheet.create({
  ...
  heroCard: { backgroundColor: C.black, borderRadius: 16, borderBottomWidth: 3, borderRightWidth: 3, borderColor: '#000', ...shadow(6, 6, C.yellow), padding: 20 },
  ...
  withdrawBtn: { flex: 1, backgroundColor: C.yellow, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', borderRadius: 10, padding: 11, alignItems: 'center' },
  withdrawBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  invoiceBtn: { flex: 1, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#fff', borderRadius: 10, padding: 11, alignItems: 'center' },
  invoiceBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.cream },
  bankCard: { backgroundColor: C.white, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(4, 4), padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10 },
  ...
  editBtn: { borderRadius: 6, paddingHorizontal: 9, paddingVertical: 3, borderBottomWidth: 2, borderRightWidth: 2, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000' },
  editBtnText: { fontFamily: F.interBold, fontSize: 11, color: C.black },
  filtersRow: { flexDirection: 'row', gap: 7, alignItems: 'center' },
  filterBtn: { flex: 1, minWidth: 60, backgroundColor: C.white, borderRadius: 20, paddingVertical: 7, paddingHorizontal: 8, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2.5, borderRightWidth: 2.5, borderTopWidth: 0, borderLeftWidth: 0, borderColor: '#000' },
  ...
  txnCard: { backgroundColor: C.white, borderRadius: 12, borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000', ...shadow(3, 3), padding: 12, flexDirection: 'row', alignItems: 'center', gap: 12 },
