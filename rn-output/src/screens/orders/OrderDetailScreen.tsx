...
const s = StyleSheet.create({
  ...
  itemRowImage: { width: 32, height: 32, borderRadius: 8, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', marginRight: 8, overflow: 'hidden' },
  ...
  backHomeBtn: { backgroundColor: C.yellow, borderRadius: 10, padding: 12, paddingHorizontal: 20, marginTop: 12, ...shadow(3, 3) },
