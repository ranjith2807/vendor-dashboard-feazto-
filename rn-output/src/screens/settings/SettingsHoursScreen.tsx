...
const s = StyleSheet.create({
  ...
  presetChip: { backgroundColor: C.white, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, ...border3D },
  presetChipText: { fontFamily: F.interBold, fontSize: 11, color: C.black },
  dayCard: { backgroundColor: C.white, borderRadius: 14, ...shadow(4, 4), ...border3D, padding: 13, marginBottom: 8 },
  dayCardClosed: { backgroundColor: '#f8f4ec', borderColor: '#ccc', shadowOpacity: 0 },
  dayRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  dayBadge: { width: 46, height: 28, borderRadius: 6, backgroundColor: C.yellow, alignItems: 'center', justifyContent: 'center', ...border3D },
  ...
  timeInput: { fontFamily: F.interBold, fontSize: 15, backgroundColor: C.cream, borderRadius: 8, padding: 8, paddingHorizontal: 10, color: C.black, ...border3D },
