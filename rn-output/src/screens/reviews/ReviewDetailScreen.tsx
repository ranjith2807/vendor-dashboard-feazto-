...
const s = StyleSheet.create({
  ...
  reviewCard: { backgroundColor: C.white, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', ...shadow(5, 5), padding: 18 },
  ...
  commentBox: { backgroundColor: '#F9FAFB', borderRadius: 10, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)' },
  ...
  dishTag: { backgroundColor: '#F3F4F6', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 5 },
  ...
  replyCard: { backgroundColor: C.white, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', ...shadow(4, 4), padding: 14 },
  replyTitle: { fontFamily: F.barlow, fontSize: 16, color: C.black, marginBottom: 10 },
  replyInput: { fontFamily: F.inter, fontSize: 13, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)', borderRadius: 10, padding: 10, paddingHorizontal: 12, height: 90, marginBottom: 10 },
