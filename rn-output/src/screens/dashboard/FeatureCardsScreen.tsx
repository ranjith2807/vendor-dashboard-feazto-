...
const s = StyleSheet.create({
  ...
  tab: { flex: 1, backgroundColor: C.white, borderRadius: 10, padding: 9, alignItems: 'center', borderWidth: 1.5, borderColor: 'rgba(0,0,0,0.10)' },
  ...
  addFirstBtn: { backgroundColor: C.yellow,  borderRadius: 10, paddingHorizontal: 22, paddingVertical: 11, ...shadow(3, 3) },
  ...
  cardRow: { backgroundColor: C.white, borderRadius: 12, ...shadow(3, 3), padding: 12, flexDirection: 'row', alignItems: 'center', gap: 12 },
  ...
  removeBtn: { backgroundColor: '#FEE2E2',  borderColor: C.red, borderRadius: 7, paddingHorizontal: 10, paddingVertical: 5 },
  removeBtnText: { fontFamily: F.interBold, fontSize: 11, color: C.red },
  searchRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.white,  borderRadius: 12, paddingHorizontal: 12, ...shadow(3, 3) },
  ...
  addBtn: { backgroundColor: C.yellow, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 7 },
  ...
  toast: { position: 'absolute', bottom: 90, left: 20, right: 20, backgroundColor: C.black,  borderColor: C.yellow, borderRadius: 12, padding: 12, alignItems: 'center', ...shadow(3, 3, C.yellow) },
