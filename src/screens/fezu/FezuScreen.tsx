...
const s = StyleSheet.create({
  ...
  tab: { flex: 1, backgroundColor: C.white, borderRadius: 20, paddingVertical: 8, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center', borderBottomWidth: 2.5, borderRightWidth: 2.5, borderColor: '#000000' },
  ...
  readyCard: { backgroundColor: C.white, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', ...shadow(4,4,'#FFC50A'), padding: 12 },
