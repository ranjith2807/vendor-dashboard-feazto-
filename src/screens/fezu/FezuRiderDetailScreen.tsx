...
const s = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: C.white, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', ...shadow(3,3), padding: 12, alignItems: 'center' },
  ...
  callBtn: { flex: 1, backgroundColor: C.green,  borderRadius: 10, padding: 11, alignItems: 'center', ...shadow(3,3) },
  callBtnText: { fontFamily: F.barlow, fontSize: 14, color: C.white },
  chatBtn: { flex: 1, backgroundColor: C.blue,  borderRadius: 10, padding: 11, alignItems: 'center', ...shadow(3,3) },
  chatBtnText: { fontFamily: F.barlow, fontSize: 14, color: C.white },
  recentCard: { backgroundColor: C.white, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', ...shadow(4,4), padding: 14 },
  ...
  assignBtn: { backgroundColor: C.yellow,  borderRadius: 12, padding: 13, alignItems: 'center', ...shadow(4,4) },
  assignBtnDisabled: { backgroundColor: '#ddd', shadowOpacity: 0 },
  assignBtnText: { fontFamily: F.barlow, fontSize: 17, color: C.black },
  confirmRow: { flexDirection: 'row', gap: 10 },
  cancelBtn: { flex: 1,  borderRadius: 10, padding: 12, alignItems: 'center', ...shadow(3,3) },
  cancelBtnText: { fontFamily: F.barlow, fontSize: 15, color: C.black },
  confirmBtn: { flex: 2, backgroundColor: C.green,  borderRadius: 10, padding: 12, alignItems: 'center', ...shadow(3,3) },
